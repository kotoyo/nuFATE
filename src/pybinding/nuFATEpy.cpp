...
BOOST_PYTHON_MODULE(nuFATEpy)
{
  ...
  class_<nuFATE, boost::noncopyable, std::shared_ptr<nuFATE> >("nuFATE",no_init)
    ...
    .def("get_arrival",&nuFATE::getArrival, args("number_of_targets","isflux"))
    .def("get_relative_attenuation",&nuFATE::getRelativeAttenuation, arg("number_of_targets"))
    .def("get_arrival_flux",&nuFATE::getArrivalFlux, arg("number_of_targets"))
    .def("get_arrival_at",&nuFATE::getArrivalAt, args("number_of_targets","energy","isflux", "start_i"))
    .def("get_arrival_flux_at",&nuFATE::getArrivalFluxAt, args("number_of_targets","energy", "start_i"))
    .def("get_relative_attenuation_at",&nuFATE::getRelativeAttenuationAt, args("number_of_targets","energy", "start_i"))
    .def("get_arrival_at_given_energies",&nuFATE::getArrivalAtGivenEnergies, args("number_of_targets","energies","isflux", "start_i"))
    .def("get_arrival_flux_at_given_energies",&nuFATE::getArrivalFluxAtGivenEnergies, args("number_of_targets","energies", "start_i"))
    .def("get_relative_attenuation_at_given_energies",&nuFATE::getRelativeAttenuationAtGivenEnergies, args("number_of_targets","energies", "start_i"))
    .def("get_initial_flux",&nuFATE::getInitialFlux)
